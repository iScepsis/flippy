<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="edit_page" data-id="{$data['page']['p_id']}" data-meta-fid="{$data['page']['p_meta_fid']}">

                <div class="form-group">
                    <label class="control-label" for="input1">Заголовок страницы</label>
                    <input name="p_title" value="{$data['page']['p_title']}" type="text" class="form-control" id="input1" aria-describedby="helpBlock1" maxlength="200">
                ...
                <span class="question_mark_text">
                    ...
                    <input name="p_view" value="{$data['page']['p_view']}" type="text" class="form-control" id="input2" aria-describedby="helpBlock2"
                ...
                <div class="form-group">
                    ...
                    <input name="meta_key" value="{$data['page']['meta_key']}" type="text" class="form-control" id="input3" aria-describedby="helpBlock3" maxlength="200">
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_description" id="input4" aria-describedby="helpBlock4" maxlength="2000" style="width: 100%; margin-bottom: 10px;">{$data['page']['meta_description']}</textarea>
                ...
                <div id="p_text">
                    ...
                    <div id="p_text_3" class="ui-widget" style="display: none">
                        <select id="combobox_2" class="fid_menus" onchange="change_record_info();">
                            <option value=""></option>
                            {foreach from=$data['lists']['menus_list'] item=menu}
                ...
                <div  class="pg-btn-container">
                    <button class="btn btn-success" onclick="edit_page(this);">
                        Изменить
                    </button>
                </div>
            </div>
